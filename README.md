...
**[📖 Read English Version](docs/README_EN.md)**
...
```bash
cd your-project
node IDE配置目录/skills/frontend-workmate/scripts/init-skills.js
# 例如：node .trae/skills/frontend-workmate/scripts/init-skills.js
# 或：node .cursor/skills/frontend-workmate/scripts/init-skills.js
```
...
- 执行 `init-skills.js` 初始化脚本（自动检测项目根目录）
- 生成任务 ID
- 创建配置文件和状态文件
